...
from valutatrade_hub.core.currencies import get_supported_currencies  # Импорт списка валют
...
def main(argv: list[str] | None = None) -> None:
    ...
    except (ValueError, CurrencyNotFoundError, InsufficientFundsError, 
            ApiRequestError) as e:
